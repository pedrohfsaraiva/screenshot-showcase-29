...
export const bom: BomLine[] = [
  ...
  line("full_valve", "sutura_montagem", null, "stentless_assembly", "TR1P-45"),
  line("full_valve", "sutura_montagem", null, "stentless_assembly", "TR1P-55"),
  line("full_valve", "sutura_loading", null, "loading_sutures", "TR1P-45"),
  line("full_valve", "sutura_loading", null, "loading_sutures", "TR1P-55"),
  line("full_valve", "fios", 0, "stentless_assembly"),
  line("full_valve", "solucao", 0, "pericardio_prep"),
  line("full_valve", "solucao_tratamento", null, "pericardio_prep", "TR1P-45"),
  line("full_valve", "solucao_tratamento", null, "pericardio_prep", "TR1P-55"),
  line("full_valve", "solucao_armazenagem", null, "storage", "TR1P-45"),
  line("full_valve", "solucao_armazenagem", null, "storage", "TR1P-55"),
