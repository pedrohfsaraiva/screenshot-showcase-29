...
export const stages: ProcessStage[] = [
  ...
  s("sealings_fixacao", 15, "Fixação atrial/ventricular sealings"),
  s("suturas_ligacao", 16, "Suturas de ligação"),
  s("dimensional_visual", 17, "Inspeções dimensional e visual da Full Valve", "inspecao"),
  s("loading_sutures", 18, "Montagem e inspeção das loading sutures"),
  s("full_bdc", 19, "Teste hidrodinâmico BDC da Full Valve", "teste"),
  s("storage", 20, "Armazenamento em solução de transporte", "armazenamento"),
  s("bioburden_pack", 21, "Redução de biocarga, embalagem primária, esterilização", "embalagem"),
  s("final_pack", 22, "Rotulagem, barrier seal, embalagem final e expedição", "embalagem"),
];
